...
function buildInventoryList(data) { 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a class='modify' href='/phpmotors/vehicles?action=mod&id=${element.invId}' title='Click to modify'>Modify</a></td>`; 
     dataTable += `<td><a class='delete' href='/phpmotors/vehicles?action=del&id=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
